...
Как видно из графиков, время CPU практически квадратично с увеличением объема данных. Время на GPU растет же скорее линейно и менее активно, чем на CPU. При использовании GPU тратится меньшее количество времени, начиная с размера = 320. 
